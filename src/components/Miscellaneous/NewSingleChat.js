      ...
      {selectedChat ? (
        <>
          ...
          <Box
            ...
            bg={`url('https://cloud.appwrite.io/v1/storage/buckets/650443d58db969add1ca/files/656317ffe762d8e369de/view?project=64fbff681fc58dbffca3&mode=admin')`}
            p={3}
            w="100%"
            h="100%"
            borderRadius="lg"
          ...
          >
            ...
            <InputGroup width={["70%", "120%", "80%"]} mr={3}>
              <Input
                variant="filled"
                bg="#E0E0E0"
              ...
              <InputRightElement width="auto">
                ...
                >
                  <Box boxSize="20px" position="relative">
                    <Image
                      src="https://cloud.appwrite.io/v1/storage/buckets/650443d58db969add1ca/files/656624ffb68c7d0d4108/view?project=64fbff681fc58dbffca3&mode=admin"
                      alt="Custom Icon"
                      objectFit="cover"
                      width="100%"
                      height="100%"
